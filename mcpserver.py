...
doctors = {
    "DOC001": {
        ...
        "hospital_affiliations": ["Emory University Hospital", "Piedmont Atlanta Hospital"],
        "education": {
    ...
    "DOC002": {
        ...
        "years_experience": 8,
        "board_certified": True,
        "hospital_affiliations": ["Phoenix Children's Hospital", "Banner Desert Medical Center"],
        "education": {
    ...
    "DOC004": {
        ...
        "years_experience": 22,
        "board_certified": True,
        "hospital_affiliations": ["National Jewish Health", "Presbyterian/Saint Joseph Hospital"],
        "education": {
        ...
        "languages": ["English"],
        "accepts_new_patients": True,
        "insurance_accepted": ["Blue Cross Blue Shield", "Aetna", "Cigna", "Workers' Compensation"]
    },
    ...
    "DOC005": {
        ...
        "years_experience": 6,
        "board_certified": True,
        "hospital_affiliations": ["Houston Methodist Hospital", "MD Anderson Cancer Center"],
        "education": {
        ...
        "accepts_new_patients": True,
        "insurance_accepted": ["Medicare", "Medicaid", "Blue Cross Blue Shield", "Humana"]
    },
    ...
    "DOC006": {
        ...
        "years_experience": 18,
        "board_certified": True,
        "hospital_affiliations": ["University of Washington Medical Center", "Swedish Medical Center"],
        "education": {
    ...
    "DOC007": {
        ...
        "years_experience": 14,
        "board_certified": True,
        "hospital_affiliations": ["Jackson Memorial Hospital", "Baptist Hospital of Miami"],
        "education": {
    ...
    "DOC008": {
        ...
        "years_experience": 11,
        "board_certified": True,
        "hospital_affiliations": ["Northwestern Memorial Hospital", "Rush University Medical Center"],
        "education": {
    ...
    "DOC009": {
        ...
        "accepts_new_patients": True,
        "insurance_accepted": ["Blue Cross Blue Shield", "Harvard Pilgrim", "Tufts Health Plan"]
    },
    ...
    "DOC010": {
        ...
        "years_experience": 16,
        "board_certified": True,
        "hospital_affiliations": ["Vanderbilt University Medical Center", "Sarah Cannon Cancer Institute"],
        "education": {
        ...
        "languages": ["English"],
        "accepts_new_patients": False,
        "insurance_accepted": ["Blue Cross Blue Shield", "Cigna", "UnitedHealth", "Medicare"]
    }
} 
